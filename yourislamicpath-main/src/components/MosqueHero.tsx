      ...
      <div className="relative z-10 min-h-[560px] flex items-center px-7 md:px-14 py-16">
        <div className="max-w-2xl text-ivory-50">
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            <Link
              to="/salah"
              className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3.5 text-emerald-950 font-semibold hover:bg-gold-400 transition-colors"
            >
              Begin learning
            ...
            <Link
              to="/quran"
              className="rounded-full border border-white/35 bg-primary-foreground/10 backdrop-blur-sm px-6 py-3.5 text-white font-medium hover:bg-card/20 transition-colors"
            >
              Explore Quran
            </Link>
          </div>
