    ...
    <div className="min-h-screen bg-ivory-50">
      ...
      <main className="max-w-5xl mx-auto px-5 py-10 md:py-16">
        <div className="max-w-2xl">
          ...
          <p className="font-arabic text-accent text-2xl mt-5">
            القرآن الكريم
          </p>
        ...
        <label className="mt-8 flex items-center gap-3 bg-card border rounded-2xl px-4 py-3">
        ...
        {isLoading && (
          <p className="mt-10 text-foreground/60">Loading Quran chapters…</p>
        )}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
          {filtered.map((surah) => (
            <Link
              ...
              className="bg-card border rounded-3xl p-5 hover:shadow-md hover:-translate-y-0.5 transition-all"
            >
              <div className="flex justify-between gap-4">
                <div className="size-9 rounded-xl bg-secondary flex items-center justify-center text-sm font-semibold">
                  {surah.number}
                </div>

                <p dir="rtl" className="font-arabic text-2xl text-accent">
                  {surah.name}
                </p>
              </div>
