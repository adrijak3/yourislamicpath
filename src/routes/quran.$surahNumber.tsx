  ...
  return (
    <>
      ...
      <button
        ...
        className="size-10 rounded-full bg-sage-100 text-emerald-800 flex items-center justify-center"
      >
        ...
        {data && (
          <>
            <header className="text-center py-10">
              <p dir="rtl" className="font-arabic text-5xl text-gold-600">
                {data.surah.name}
              </p>

              <h1 className="font-serif italic text-4xl text-emerald-900 mt-3">
                {data.surah.englishName}
              </h1>

              <p className="text-sm text-emerald-900/55 mt-2">
            ...
            <div className="space-y-5">
              {data.ayahs.map((ayah) => (
                ...
                >
                  ...
                  <p className="border-t mt-6 pt-5 text-emerald-900/70 leading-relaxed">
                    {ayah.translation}
                  </p>
                </article>
              ))}
