  ...
  return (
    <div className="min-h-screen bg-ivory-50">
      ...
      <main className="max-w-5xl mx-auto px-5 py-12">
        ...
        <p className="font-arabic text-2xl text-gold-600 mt-5">السنة</p>

        <h1 className="font-serif italic text-5xl text-emerald-900">
          Small Sunnah habits
        </h1>

        <p className="max-w-2xl text-emerald-900/65 mt-4">
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-10">
          {SUNNAH_LESSONS.map((lesson) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-emerald-900/65 mt-3">
                {lesson.description}
              </p>

              <div className="bg-sage-100 rounded-2xl p-4 mt-5">
